...
public class DrawSquareTable extends JComponent implements MouseListener {
	...
	public DrawSquareTable(Table t) {
		this.t = t;
	...
	public void paintComponent(Graphics g) {
		...
		if(t.isStatus() == true) {
			...
			g.fillRect(13, 13, t.getSize().width, t.getSize().width);
			g.setColor(Color.BLACK);
			if(t.getNumber() > 9) {
				g.drawString(Integer.toString(t.getNumber()), t.getSize().width/2 + 7, t.getSize().width/2 + 18);
			} else {
				g.drawString(Integer.toString(t.getNumber()), t.getSize().width/2 + 10, t.getSize().width/2 + 18);
			}
			...
			{
				if(i % 4 == 0) {
					g.fillRect(0, (t.getSize().width/2 + 8) / counter, 10, 10);
				}
				if(i % 4 == 1) {
					g.fillRect((t.getSize().width + 15), (t.getSize().width/2 + 8) / counter, 10, 10);
				}
				if(i % 4 == 2) {
					g.fillRect((t.getSize().width/2 + 8) / counter, 0, 10, 10);
				}
				if(i % 4 == 3) {
					g.fillRect((t.getSize().width/2 + 8) / counter, (t.getSize().width + 15), 10, 10);
					counter++;
				}
			}
		}
